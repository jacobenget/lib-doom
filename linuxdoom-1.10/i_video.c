...
void I_FinishUpdate( void ) {
  ...
  if ( doShm ) {
    ...
    if ( !XShmPutImage( X_display, X_mainWindow, X_gc, image, 0, 0, 0, 0,
...
void I_InitGraphics( void ) {
  ...
  X_mainWindow = XCreateWindow( X_display, RootWindow( X_display, X_screen ), x,
                                y, X_width, X_height,
                                0, // borderwidth
                                8, // depth
  ...
  if ( doShm ) {
    ...
    image = XCreateImage( X_display, X_visual, 8, ZPixmap, 0,
                          (char *)malloc( X_width * X_height ), X_width,
                          X_height, 8, X_width );
  }
